...
func evaluate(good: String, vsEvil evil: String) -> String {
    ...
    if totalGoodWorths > totalEvilWorths { return "Battle Result: Good triumphs over Evil" }
    else if totalGoodWorths == totalEvilWorths { return "Battle Result: No victor on this battle field" }
